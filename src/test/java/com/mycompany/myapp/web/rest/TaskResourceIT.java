...
class TaskResourceIT {
    ...
    public static Task createEntity(EntityManager em) {
        Task task = new Task().titre(DEFAULT_TITRE).description(DEFAULT_DESCRIPTION);
        return task;
    }
    ...
    public static Task createUpdatedEntity(EntityManager em) {
        Task task = new Task().titre(UPDATED_TITRE).description(UPDATED_DESCRIPTION);
        return task;
    }
    ...
    void createTask() throws Exception {
        ...
        assertThat(testTask.getTitre()).isEqualTo(DEFAULT_TITRE);
    ...
    void putNewTask() throws Exception {
        ...
        updatedTask.titre(UPDATED_TITRE).description(UPDATED_DESCRIPTION);
        ...
        Task testTask = taskList.get(taskList.size() - 1);
        assertThat(testTask.getTitre()).isEqualTo(UPDATED_TITRE);
    ...
    void fullUpdateTaskWithPatch() throws Exception {
        ...
        partialUpdatedTask.titre(UPDATED_TITRE).description(UPDATED_DESCRIPTION);
